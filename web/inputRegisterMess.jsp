...
<jsp:useBean id="userBean" class="classes.data.Register" scope="request"/>
<HEAD><%@ include file="WEB-INF/ch10/head" %></HEAD>
<title>注册页面</title>
<HTML><BODY background="image/bg.png"><Font size=2>
<div align="center">
